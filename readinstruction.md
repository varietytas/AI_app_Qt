...
## Шаг 6
Нажмите кнопку **Edit**, _зарегистрируйтесь в Strapi_* (если еще не сделали этого), войдите в проект **Blogs** и отформатируйте, отредактируйте пост. Сохраните изменения и опубликуйте пост в Strapi.
<div style="display: flex; justify-content: center; flex-wrap: wrap;">
